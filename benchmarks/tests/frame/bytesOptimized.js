...
export async function runBenchmark() {
  ...
  suite
    .add(
      'CodDicomWebServer.fetchCod - frame, BYTES_OPTIMIZED, CT-MultiInstance, first slice',
    ...
    .add(
      'CodDicomWebServer.fetchCod - frame, BYTES_OPTIMIZED, CT-MultiInstance, all slices',
      createBenchmarkTestOptions(async () => {
        server = new CodDicomWebServer();
        const promises = [];
    ...
    .add(
      'CodDicomWebServer.fetchCod - frame, BYTES_OPTIMIZED, MR-Multiframe, first slice',
      createBenchmarkTestOptions(async () => {
        server = new CodDicomWebServer();
    ...
    .add(
      'CodDicomWebServer.fetchCod - frame, BYTES_OPTIMIZED, MR-Multiframe, all slices',
      createBenchmarkTestOptions(async () => {
        server = new CodDicomWebServer();
        const promises = [];
    ...
    .add(
      'CodDicomWebServer.fetchCod - frame, BYTES_OPTIMIZED, OPT-Multiframe, first slice',
      createBenchmarkTestOptions(async () => {
        server = new CodDicomWebServer();
    ...
    .add(
      'CodDicomWebServer.fetchCod - frame, BYTES_OPTIMIZED, OPT-Multiframe, all slices',
      createBenchmarkTestOptions(async () => {
        server = new CodDicomWebServer();
        const promises = [];
    ...
    .add(
      'CodDicomWebServer.fetchCod - frame, BYTES_OPTIMIZED, MG-Multiframe, first slice',
      createBenchmarkTestOptions(async () => {
        server = new CodDicomWebServer();
    ...
    .add(
      'CodDicomWebServer.fetchCod - frame, BYTES_OPTIMIZED, MG-Multiframe, all slices',
      createBenchmarkTestOptions(async () => {
        server = new CodDicomWebServer();
        const promises = [];
    ...
    .add(
      'CodDicomWebServer.fetchCod - frame, BYTES_OPTIMIZED, MG-Singleframe, first slice',
      createBenchmarkTestOptions(async () => {
        server = new CodDicomWebServer();
